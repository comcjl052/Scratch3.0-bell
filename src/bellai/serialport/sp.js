...
if (process.env.NODE_ENV === 'development') {
  SerialPort = require('./serialport-mock.js').default;
} else {
  SerialPort = require('serialport')
}

import util from './util.js';
import cmdControl from './plugin/cmdControl.js';
import fileTransfer from './plugin/fileTransfer.js';
import logger from 'loglevel';
const log = logger.getLogger('serialport');
